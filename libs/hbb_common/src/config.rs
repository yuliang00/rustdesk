...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rc.ppyd0.top"];
pub const PUBLIC_RS_PUB_KEY: &str = "y1x0U8chGr/x07ApTkGNn20ji6jdiqoCgTzSjgmXZoouOFsP48v41Dwm5yvr37rVHW5CfmlqaFewm2FemEO6jw==";
